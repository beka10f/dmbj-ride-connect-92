    ...
    <footer className="bg-primary text-white py-8 px-4 sm:py-12">
      <div className="max-w-7xl mx-auto grid grid-cols-1 sm:grid-cols-2 md:grid-cols-3 gap-8">
        <div className="text-center sm:text-left">
          <h3 className="text-base sm:text-lg font-bold mb-3 sm:mb-4 text-secondary">DMBJ Transportation</h3>
          <p className="text-sm sm:text-base text-gray-300">
            Providing luxury transportation services with style and comfort.
          </p>
        </div>
        <div className="text-center sm:text-left">
          <h3 className="text-base sm:text-lg font-bold mb-3 sm:mb-4 text-secondary">Quick Links</h3>
